...
| --- | --- | --- |
| A **model provider key** — OpenAI, Anthropic, Google, DeepSeek, or MiniMax | [https://www.bigbooks.app/ai-secrets](https://www.bigbooks.app/secrets) | Every answer is a call billed to your provider account |
...
Add one at **[https://www.bigbooks.app/ai-secrets](https://www.bigbooks.app/secrets)**. Without it the first message comes back with
...
- a **model provider key** at **[https://www.bigbooks.app/ai-secrets](https://www.bigbooks.app/secrets)**, or the assistant cannot answer
